...
_LEC_NAME = _descriptor.Descriptor(
  name='Lec_Name',
  full_name='Lec_Name',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='title', full_name='Lec_Name.title', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LECTURER = _descriptor.Descriptor(
  name='Lecturer',
  full_name='Lecturer',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='Lecturer.name', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='faculty', full_name='Lecturer.faculty', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='yearOfBirth', full_name='Lecturer.yearOfBirth', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='exists', full_name='Lecturer.exists', index=3,
...
_LECTURER.fields_by_name['name'].message_type = _LEC_NAME
_LECTURER.fields_by_name['faculty'].message_type = _FACULTY
...
DESCRIPTOR.message_types_by_name['Lec_Name'] = _LEC_NAME
DESCRIPTOR.message_types_by_name['Lecturer'] = _LECTURER
...
Lec_Name = _reflection.GeneratedProtocolMessageType('Lec_Name', (_message.Message,), {
  'DESCRIPTOR' : _LEC_NAME,
  '__module__' : 'student_pb2'
  # @@protoc_insertion_point(class_scope:Lec_Name)
  })
_sym_db.RegisterMessage(Lec_Name)

Lecturer = _reflection.GeneratedProtocolMessageType('Lecturer', (_message.Message,), {
  'DESCRIPTOR' : _LECTURER,
  '__module__' : 'student_pb2'
  # @@protoc_insertion_point(class_scope:Lecturer)
  })
_sym_db.RegisterMessage(Lecturer)
...
_STUDENTS = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='ListLecturer',
    full_name='Students.ListLecturer',
    index=2,
    containing_service=None,
    input_type=_LEC_NAME,
    output_type=_LECTURER,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='ListLecturers',
    full_name='Students.ListLecturers',
    index=3,
    containing_service=None,
    input_type=_FACULTY,
    output_type=_LECTURER,
